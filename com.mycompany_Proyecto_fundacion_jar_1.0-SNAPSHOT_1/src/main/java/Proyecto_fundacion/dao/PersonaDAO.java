...
public class PersonaDAO {
    ...
    public boolean Modify(Personas personas) throws SQLException{
        int llave_foranea = 0;
        Connection con = new Conexion().getConnection();
        //= null; //se inicializa en nulo, es el que prepara la consulta
    ...
    public boolean Store(Personas personas) throws SQLException{
        Connection con = new Conexion().getConnection();
